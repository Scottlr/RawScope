...
fn density_colour(intensity: f32) -> vec3<f32> {
    let background = vec3<f32>(0.015, 0.025, 0.035);
    let low_density = vec3<f32>(0.02, 0.19, 0.28);
    let mid_density = vec3<f32>(0.08, 0.55, 0.58);
    let high_density = vec3<f32>(1.0, 0.74, 0.30);
