...
| T005 | [ ] | Introduce Checked Core Domain Contracts | Make foundational ranges, dimensions, identities, selections, and owner-minted generations difficult to misuse without adding dependencies. |  | None | [`tasks/T005.md`](tasks/T005.md) |
| T006 | [ ] | Add A Typed Rectangular DatasetStore | Replace publicly mutable row/table shapes with a generation-owned store that separates raw, normalized, missing, and invalid values. |  | T005 | [`tasks/T006.md`](tasks/T006.md) |
