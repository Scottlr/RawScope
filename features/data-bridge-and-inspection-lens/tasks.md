...
| T012 | [x] | Harden The Bridged Inspection Workflow | Integrate the Python-to-native and inspect-to-evidence paths, close real UI/performance inconsistencies, and validate both external Lichess scales without adding hidden architecture. |  | T004, T005, T009, T010, T011 | [`tasks/T012.md`](tasks/T012.md) |
