...
| T013 | [x] | Add Resident GPU Density Ridge Presentation | Compute and render generation-safe ridge strength/orientation fields only on settled compatible density generations, with CPU/GPU parity and no motion implication. | 1a9fe41 | T002, T003, T004, T012 | [`tasks/T013.md`](tasks/T013.md) |
